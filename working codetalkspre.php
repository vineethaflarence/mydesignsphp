...
<!--Previous Event!-->
        <div class="row">
            <div class="col-12 m-3 mb-3">
                ...
                $paged_events = array_slice($previousEvents, $offset, $items_per_page);

                foreach ($paged_events as $index => $event):
         ?>
		 <div class="card col-lg-3 col-md-6 col-sm-12" style="flex: 0 0 calc(25% - 10px); max-width: calc(25% - 10px); margin: 5px; background-color: #ECECEC;">
            <a href="#" data-toggle="modal" data-target="#eventModalprevious">
                <img src="<?= !empty($event['photo']) ? $event['photo'] : 'https://i.postimg.cc/cJw84dHd/45e21f7d9539e30d1d7388bac53c6813.jpg' ?>" class="img-fluid" alt="Event Image">
